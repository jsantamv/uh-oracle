...
----------------------< #7 >-------------------------------
/* Consulta SQL para conocer el tama�o ocupado por una tabla 
en espec�fico incluyendo los �ndices de la misma */
...
--existen en la bd y cual es su datafile asociado as� como 
--el tama�o asignado
...
----------------------< #10 >-------------------------------
--�C�mo puedo extraer el DDL de un procedimiento almacenado 
...
-- Realice una consulta que muestre la siguiente información 
-- de los archivos temporales de la base de datos

-- - id file, nombre del archivo, tamaño actual en GB, 
-- tamaño máximo en GB, si es autoextendible, 
